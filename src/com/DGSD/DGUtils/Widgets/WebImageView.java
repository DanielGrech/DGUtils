...
import com.DGSD.DGUtils.DGUtils;
import com.DGSD.DGUtils.ImageDownloader.ImageLoader;
import com.DGSD.DGUtils.ImageDownloader.ImageLoaderHandler;
...
public class WebImageView extends ViewSwitcher {
    ...
    public WebImageView(Context context, AttributeSet attributes) {
        ...
        int progressDrawableId = attributes.getAttributeResourceValue(DGUtils.XMLNS,
                "progressDrawable", 0);
        int errorDrawableId = attributes.getAttributeResourceValue(DGUtils.XMLNS, "errorDrawable",
                0);
        ...
        initialize(context, attributes.getAttributeValue(DGUtils.XMLNS, "imageUrl"),
                progressDrawable, errorDrawable, attributes.getAttributeBooleanValue(
                        DGUtils.XMLNS, "autoLoad",
                        true));
        // styles.recycle();
    }
