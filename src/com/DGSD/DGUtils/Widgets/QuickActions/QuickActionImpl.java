 ...
 */
public class QuickActionImpl extends PopupWindows implements OnDismissListener, IQuickAction {
	...
	public QuickActionImpl(Context context) {
		...
		setRootViewId(R.layout.quick_action_base);
		...
		container.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mItemClickListener != null) {
                    mItemClickListener.onItemClick(QuickActionImpl.this, pos, actionId);
                }
	 ...
	 */
	public void setOnDismissListener(QuickActionImpl.OnDismissListener listener) {
